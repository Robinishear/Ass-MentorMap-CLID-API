    ...
    <div className='min-h-screen '>
      ...
      <header className=' sticky top-0 z-40'>
        <div className='max-w-7xl mx-auto px-6 h-20 flex items-center justify-between'>
          ...
          <nav className='hidden md:flex items-center gap-8'>
            <Link
              href='/meals'
              className='text-xs font-black uppercase tracking-widest text-white hover:text-brand transition-colors'>
              Browse Meals
            </Link>
            <Link
              href='/restaurants'
      ...
      <main className='max-w-7xl mx-auto px-6 py-16'>
        ...
        <div className='space-y-6 mb-16'>
          ...
          <p className='max-w-2xl text-lg font-medium text-gray-100 leading-relaxed'>
        ...
        <div className='flex items-center gap-6 mb-12'>
          <div className='relative w-full grow'>
            ...
            <Input
              ...
              className='h-16 pl-12 pr-6 border-4 border-charcoal bg-white/20 rounded-none text-lg font-black placeholder:text-gray-300  focus-visible:ring-offset-0 focus-visible:ring-4 uppercase tracking-tighter'
              value={searchQuery}
      ...
      {/* --- Footer --- */}
      {/* <footer className=' text-white pt-20 pb-12 border-t-8 border-brand'>
