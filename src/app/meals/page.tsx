...
export default function MealsPage() {
  ...
  return (
    <div className='min-h-screen '>
      {/* --- Simple Navigation --- */}
      <header className='bg-white/10 sticky top-0 z-40'>
        <div className='max-w-7xl mx-auto px-6 h-20 flex items-center justify-between'>
          <Link href='/' className='group'>
            <span className='text-3xl font-serif font-black tracking-tighter text-white transition-colors'>
              FOOD
              <span className='text-blue-700 transition-colors'>
                HUB
              </span>
            </span>
          </Link>
          ...
          <nav className='hidden md:flex items-center gap-8'>
            ...
            <Link
              href='/restaurants'
              className='text-xs font-black uppercase tracking-widest text-white transition-colors'>
              Restaurants
            </Link>
            <Link
              href='/account'
      ...
      <main className='max-w-7xl mx-auto px-6 py-16'>
        ...
        <div className='space-y-6 mb-16'>
          ...
          <h1 className='text-6xl md:text-8xl font-serif font-black text-blue-700 leading-[0.9] tracking-tighter italic'>
            Chef&apos;s <br />
            <span className='text-white not-italic'>Selection.</span>
          </h1>

          <p className='max-w-2xl text-lg font-medium text-white leading-relaxed'>
        ...
        <div className='space-y-8 mb-12'>
          ...
          <div className='relative w-full'>
            ...
            <Input
              ...
              className='h-16 pl-12 pr-6 border-4 border-charcoal bg-white/20 rounded-none text-lg font-black   focus-visible:ring-offset-0 focus-visible:ring-4 uppercase tracking-tighter'
              value={searchQuery}
        ...
        {isLoading ? (
          ...
          <div className='py-40 text-center space-y-8 '>
            ...
            <div className='space-y-2'>
              <h2 className='text-4xl font-serif font-black text-blue-700 tracking-tighter uppercase'>
                No flavor found
              </h2>
