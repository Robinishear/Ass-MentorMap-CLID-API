...
import HomePageDesign from "./HomeDesign";
  ...
  return (
    <div className='flex flex-col min-h-screen'>
      ...
      <header className='fixed top-0 left-0 right-0 z-50 px-6 py-4'>
        <div className='max-w-7xl mx-auto flex items-center justify-between bg-white/10 backdrop-blur-md  px-6 py-3 shadow-[8px_8px_0px_0px_rgba(10,10,10,1)]'>
          ...
          <div className='flex items-center gap-4'>
            {isPending ? (
              ...
              <Link
                href='/login'
                className='hidden md:block text-sm  text-white font-bold uppercase tracking-widest hover:text-brand transition-colors'>
