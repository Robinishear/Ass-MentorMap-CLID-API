...
export default function RegisterPage() {
  ...
  <h1 className="text-2xl font-serif font-black text-white tracking-tighter italic border-l-4 border-orange-500 pl-4">
              Create Account
  </h1>
</div>
                    ...
                    <FormItem className='space-y-2'>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className='h-14 border-[3px] border-white/10 text-white bg-white/8  rounded-none text-lg font-bold placeholder:text-gray-300  focus-visible:ring-3 focus-visible:ring-offset-0 placeholder:font-medium placeholder:uppercase placeholder:text-xs'
                          {...field}
                        />
                      </FormControl>
                    ...
                    <FormItem className='space-y-2'>
                      ...
                      <FormControl>
                        <Input
                          type='password'
                          placeholder='*******'
                          className='h-14 border-[3px] border-white/10 text-white bg-white/8  rounded-none text-xl tracking-widest  focus-visible:ring-3 focus-visible:ring-offset-0'
                          {...field}
                        />
                      </FormControl>
                      <FormMessage className='text-[10px] font-bold uppercase text-destructive tracking-widest' />
