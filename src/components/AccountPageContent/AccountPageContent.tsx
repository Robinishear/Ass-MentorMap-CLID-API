      ...
      <main className='max-w-7xl mx-auto px-6 pt-32 pb-20'>
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-12'>
            ...
            <div className='bg-white border-4 border-charcoal p-6 shadow-[8px_8px_0px_0px_rgba(10,10,10,1)]'>
              ...
              <div className='space-y-4'>
                ...
                {user.role === "provider" && (
                  <Button
                    asChild
                    className='w-full bg-brand text-blue-700 font-black uppercase tracking-widest text-[10px] h-12 rounded-none border-2 border-charcoal shadow-[4px_4px_0px_0px_rgba(10,10,10,1)] hover:bg-white hover:text-brand transition-all mt-4'>
                    <Link
          ...
          <div className='lg:col-span-3'>
            <h1 className='text-5xl font-serif font-black text-blue-700 tracking-tighter mb-8 italic'>
              Dashboard
            </h1>
              ...
              <div className='mt-8'>
                <TabsContent value='profile' className='space-y-8'>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    <Card className='rounded-none border-4 border-charcoal bg-white/10 '>
                      <CardHeader>
                        <CardTitle className='font-serif font-black text-2xl uppercase tracking-tighter text-white'>
                          Account Overview
                        </CardTitle>
                      ...
                      <CardContent className='grid grid-cols-1 gap-8'>
                        <div className='space-y-4'>
                          <div className='space-y-1'>
                            <p className='text-[10px] font-black uppercase text-gray-100'>
                              Full Name
                            </p>
                        ...
                        {user.role !== "provider" && (
                          <div className='bg-white/10 border-2 border-charcoal border-dashed p-6 flex flex-col justify-center items-center text-center gap-4'>
                ...
                <TabsContent value='orders'>
                  <Card className='rounded-none border-4 border-charcoal bg-white/10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]'>
                    <CardHeader>
